...
=======
〜使い方〜
1, cd command_generator
2, source .venv/bin/activate
3, cd Commandgenerator_erasers/src
4, python3 -m robocupathome_generator.generator -d ./robocupathome_generator/data_dir/
>>>>>>> a861b4a (Add command generator files)
